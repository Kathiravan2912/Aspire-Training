...
const Customers = () => {
  ...
  const [customerCount, setCustomerCount] = useState(0);         //new for count
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        setCustomerCount(response.data.length); // Update customer count new code
  ...
  const CustomersCount= filteredItems.length;
  ...
  return (
    <>
      <div id="content-normal" className="content">
        ...
        <div>
          <h1  className="tableTopic">Customer's Data</h1>
